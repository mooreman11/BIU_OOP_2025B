...
public class Line {
    ...
    public Point intersectionWith(Line other) {
        ...
        if (thresholdComparison(determinant, 0d)) {
            return null;
        }
    ...
    public boolean equals(Line other) {
        return (thresholdComparison(this.start.getX(), other.start.getX())
                && thresholdComparison(this.end.getX(), other.end.getX())
                && thresholdComparison(this.start.getY(), other.start.getY())
                && thresholdComparison(this.end.getY(), other.end.getY()));
    }
